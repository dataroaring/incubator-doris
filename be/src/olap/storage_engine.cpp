...
StorageEngine::StorageEngine(const EngineOptions& options)
        : _options(options),
          ...
          _segment_meta_mem_tracker1(std::make_shared<MemTracker>("Segmentopen")),
          _segment_meta_mem_tracker2(std::make_shared<MemTracker>("Segmentparsefoot")),
          _segment_meta_mem_tracker3(std::make_shared<MemTracker>("Segmentcolumnreader")),
          _segment_meta_mem_tracker4(std::make_shared<MemTracker>("Segmentcolumnpb")),
          _segment_meta_mem_tracker5(std::make_shared<MemTracker>("Segmentcolumn")),
          _segment_meta_mem_tracker6(std::make_shared<MemTracker>("colnumscreator")),
          _segment_meta_mem_tracker7(std::make_shared<MemTracker>("ORDINAL_INDEX")),
          _segment_meta_mem_tracker8(std::make_shared<MemTracker>("ZONE_MAP_INDEX")),
          _segment_meta_mem_tracker9(std::make_shared<MemTracker>("type")),
          _segment_meta_mem_tracker10(std::make_shared<MemTracker>("type1")),
          _segment_meta_mem_tracker11(std::make_shared<MemTracker>("read footer")),
          _segment_meta_mem_tracker12(std::make_shared<MemTracker>("meta")),
          _segment_meta_mem_tracker13(std::make_shared<MemTracker>("sizeofreader")),
